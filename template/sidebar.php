<aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
    <div class="sidebar-brand">
        <a href="index.php" class="brand-link">
            <img src="assets/img/alLogo2.jpg" alt="AdminLTE Logo" class="brand-image opacity-75 shadow" />
            <span class="brand-text fw-light">Ambarie Luxe</span>
        </a>
    </div>
    ...
    <div class="sidebar-wrapper">
        <nav class="mt-2">
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="navigation" aria-label="Main navigation" data-accordion="false" id="navigation">
                ...
                <li class="nav-item">
                    <a href="master-jenis-list.php" class="nav-link">
                        <i class="nav-icon bi bi-droplet-half"></i>
                        <p>Jenis Parfum</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="master-aroma-list.php" class="nav-link">
                        <i class="nav-icon bi bi-wind"></i>
                        <p>Aroma Parfum</p>
                    </a>
                </li>
            </ul>
